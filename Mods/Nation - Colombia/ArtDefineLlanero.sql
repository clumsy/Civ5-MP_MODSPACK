INSERT INTO ArtDefine_UnitInfos (Type,DamageStates,Formation)
	SELECT	('ART_DEF_UNIT_GRANCOLOMBIA_LLANERO'), DamageStates, Formation
	FROM ArtDefine_UnitInfos WHERE (Type = 'ART_DEF_UNIT_LANCER');

INSERT INTO ArtDefine_UnitInfoMemberInfos (UnitInfoType,UnitMemberInfoType,NumMembers)
	SELECT	('ART_DEF_UNIT_GRANCOLOMBIA_LLANERO'), ('ART_DEF_UNIT_MEMBER_GRANCOLOMBIA_LLANERO'), NumMembers
...
INSERT INTO ArtDefine_StrategicView (StrategicViewType, TileType, Asset )
	SELECT	('ART_DEF_UNIT_GRANCOLOMBIA_LLANERO'), TileType, Asset
