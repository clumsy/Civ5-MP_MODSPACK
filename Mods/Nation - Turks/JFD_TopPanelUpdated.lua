...
function UpdatedGoldTipHandler( control )
	...
	local iTotalExpenses = iUnitCost + iUnitSupply + iBuildingMaintenance + iImprovementMaintenance + iGoldPerTurnToOtherPlayers + iReformMaintenance; 
...
if ((not isPietyActive) and (not isUsingCBP)) then
...
-- Register Events
if ((not isPietyActive) and (not isUsingEUITopPanel) and (not isUsingCBP)) then
