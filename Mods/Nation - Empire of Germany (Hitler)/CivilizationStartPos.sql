...
INSERT INTO Civilizations_YagemStartPosition
			(Type,								X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_JFD_NAZI_GERMANY',	22,		69,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_YahemStartPosition
			(Type,								X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_JFD_NAZI_GERMANY',	64,		61,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_CordiformStartPosition
			(Type,								X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_JFD_NAZI_GERMANY',	39,		32,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_GreatestEarthStartPosition
			(Type,								X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_JFD_NAZI_GERMANY',	51,		53,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_EuroLargeStartPosition
			(Type,								X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_JFD_NAZI_GERMANY',	37,		47,		null,	null);
--==========================================================================================================================
