...
ContextPtr:LoadNewContext("JFD_CoreFunctions")
...
ContextPtr:LoadNewContext("JFD_MilanCityInfo")
ContextPtr:LoadNewContext("JFD_MilanFunctions")
ContextPtr:LoadNewContext("CityInfoStack")
ContextPtr:LoadNewContext("JFD_GermansFunctions")
ContextPtr:LoadNewContext("JFD_GermanyFunctions")
ContextPtr:LoadNewContext("JFD_AustrianCoffeeHouseFunctions")
ContextPtr:LoadNewContext("JFD_GreatGalleassFunctions")
ContextPtr:LoadNewContext("JFD_HolyRomanFunctions")
ContextPtr:LoadNewContext("JFD_MerchantOfVeniceFunctions")
ContextPtr:LoadNewContext("Leninist Russia Functions")
ContextPtr:LoadNewContext("JFD_USSRStalinCityInfo")
ContextPtr:LoadNewContext("CityInfoStack")
ContextPtr:LoadNewContext("JFD_USSRStalinFunctions")
ContextPtr:LoadNewContext("JFD_SwitzerlandFunctions")
...
ContextPtr:LoadNewContext("JFD_JapanTojoFunctions")
...
ContextPtr:LoadNewContext("JFD_ScotlandFunctions")
ContextPtr:LoadNewContext("JFD_UnitedKingdomFunctions")
ContextPtr:LoadNewContext("JFD_PrussiaFunctions")
ContextPtr:LoadNewContext("JFD_DenmarkNorwayFunctions")
ContextPtr:LoadNewContext("JFD_BavariaChooseWonderCityPopup")
ContextPtr:LoadNewContext("JFD_BavariaFunctions")
ContextPtr:LoadNewContext("JFD_BelgiumFunctions")
ContextPtr:LoadNewContext("JFD_BohemiaFunctions")
ContextPtr:LoadNewContext("JFD_GreatBritainCityInfo")
ContextPtr:LoadNewContext("JFD_GreatBritainFunctions")
ContextPtr:LoadNewContext("JFD_RedcoatCityInfo")
ContextPtr:LoadNewContext("CityInfoStack")
ContextPtr:LoadNewContext("ChooseArchdiocesePopup")
...
ContextPtr:LoadNewContext("CityInfoStack")
ContextPtr:LoadNewContext("JFD_CarthageFunctions")
ContextPtr:LoadNewContext("JFD_KrepostCityInfo")
ContextPtr:LoadNewContext("JFD_RussiaPeterFunctions")
ContextPtr:LoadNewContext("CityInfoStack")
ContextPtr:LoadNewContext("Lincoln America Functions")
ContextPtr:LoadNewContext("JFD_GuberniyasOfficeCityInfo")
...
-- Nation - Sicily --
ContextPtr:LoadNewContext("Sicily_Functions")
